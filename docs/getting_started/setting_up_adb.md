...
![Platform Tools installer button](../images/setting_up_adb/platform-tools-install-example.webp)
...
![Manual Platform tools path](../images/setting_up_adb/platform-tools-manual-path-example.webp)
